...
const page = async({params}:{params:Promise<{id:string}>}) => {
    ...
    const [post,{select:editorPosts}]=await Promise.all([client.fetch(STARTUPS_BY_ID_QUERY,{ id}),
  ...
  return (
    <>
    <section className="pint-container !min-h-[230px]">
        ...
        <Image src={post.image} alt="thumbnail"className='w-full h-auto rounded-xl' />
         ...
         <div className='space-y-5 mt-10 max-w-4xl mx-auto'>
            <div className='flex-between gap-5'>
                ...
                className='flex gaap-2 items-center mb-3'>
                    <Image 
